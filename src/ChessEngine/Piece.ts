...
export class Piece extends Number {
	...
	public static readonly WHITE_KNIGHT = new Piece(PieceType.KNIGHT, Side.WHITE);
	public static readonly WHITE_BISHOP = new Piece(PieceType.BISHOP, Side.WHITE);
	...
	public static readonly BLACK_KNIGHT = new Piece(PieceType.KNIGHT, Side.BLACK);
	public static readonly BLACK_BISHOP = new Piece(PieceType.BISHOP, Side.BLACK);
