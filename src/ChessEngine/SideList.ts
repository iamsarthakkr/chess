...
export class SideList {
   ...
   constructor(side: Side) {
      ...
      this.m_pawns = new PieceList(
         Piece.get_piece_from_char(Symbols.PAWN, side)
      );
      this.m_knights = new PieceList(
         Piece.get_piece_from_char(Symbols.KNIGHT, side)
      );
      this.m_bishops = new PieceList(
         Piece.get_piece_from_char(Symbols.BISHOP, side)
      );
      this.m_rooks = new PieceList(
         Piece.get_piece_from_char(Symbols.ROOK, side)
      );
      this.m_queens = new PieceList(
         Piece.get_piece_from_char(Symbols.QUEEN, side)
      );
      this.m_kings = new PieceList(
         Piece.get_piece_from_char(Symbols.KING, side)
      );
   }
